...
const data = {
    ...
    api: [
        ...
        },
        {
            ...
            type: 'string',
            default: '-',
            description: 'Same as target attribute of a, works when href is specified only works with link variant'
        },
        {
            property: 'disabled',
            type: 'boolean',
            default: 'false',
            description: 'disable the button from being pressed, will not work with link variant'
        },
        {
            property: 'onClick',
            type: '() => void',
